...
MESSAGES = {
    ...
    'INVALID_SYMBOL':              "Please enter a valid asset symbol (e.g., AAPL, BTC).",
    ...
    'FEES_EXCEED_PROCEEDS':        "Fee cannot exceed the sale proceeds.",
    'PORTFOLIO_NAME_TAKEN':        "A portfolio with this name already exists.",
    'SYMBOL_ALREADY_TRACKED':      "'{symbol}' is already being tracked as an asset in this portfolio.",

    # Transactions
    'TRANSACTION_ADDED':           "Asset entry added.",
    'TRANSACTION_UPDATED':         "Entry updated.",
    'TRANSACTION_REMOVED':         "Entry removed.",

    # Tracked symbols
    'SYMBOL_ADDED':                "'{symbol}' asset added to portfolio.",
    'SYMBOL_REMOVED':              "Asset removed.",
    ...
    'SYMBOL_TOO_LONG':             "Asset symbol must be 20 characters or less.",
    ...
    'SYMBOL_REQUIRED':             "Please enter an asset symbol (e.g., AAPL, BTC).",
